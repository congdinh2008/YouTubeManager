...
namespace YouTubeManager.Models.MediaStreams
{
    ...
    public static class Extensions
    {
        ...
        {
            framerate.EnsureNotNegative(nameof(framerate));
        ...
        {
            streamInfoSet.EnsureNotNull(nameof(streamInfoSet));
        ...
        {
            streamInfos.EnsureNotNull(nameof(streamInfos));
        ...
        {
            streamInfo.EnsureNotNull(nameof(streamInfo));
