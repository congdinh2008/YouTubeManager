...
namespace YouTubeManager
{
    public partial class YouTubeService
    {
        ...
        {
            videoUrl.EnsureNotNull(nameof(videoUrl));
        ...
        {
            playlistUrl.EnsureNotNull(nameof(playlistUrl));
        ...
        {
            channelUrl.EnsureNotNull(nameof(channelUrl));
